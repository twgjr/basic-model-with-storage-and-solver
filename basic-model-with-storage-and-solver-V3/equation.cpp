...
QVector<Variable *> Equation::variableList() const
{
    return m_variableList;
}

void Equation::setVariableList(const QVector<Variable *> &variableList)
{
    m_variableList = variableList;
}

void Equation::appendVariable()
{
    m_variableList.append(new Variable(m_equationContext));
}

void Equation::removeVariable(int index)
{
    m_variableList.removeAt(index);
}

void Equation::updateVariable(int index,Variable* variable)
{
    m_variableList[index]=variable;
}
...
QVector<Constant *> Equation::constantList() const
{
    return m_constantList;
}

void Equation::setConstantList(const QVector<Constant *> &constantList)
{
    m_constantList = constantList;
}

void Equation::appendConstant()
{
    m_constantList.append(new Constant(m_equationContext));
}

void Equation::removeConstant(int index)
{
    m_constantList.removeAt(index);
}

void Equation::updateConstant(int index, Constant * constant)
{
    m_constantList[index]=constant;
}

void Equation::clearConstantList()
{
